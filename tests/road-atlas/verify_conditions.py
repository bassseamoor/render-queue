...
with sync_playwright() as p:
 ...
 sources={'vendor/road-atlas-baseline-329a68a.html':baseline.replace('randomSeed:function(){return randomSeedStr();}',"randomSeed:function(){return '"+SEEDS[0]+"';}"),'road-atlas-pipeline.js':module,'road-atlas-conditions.js':conditions,'road-atlas-urban.js':(ROOT/'road-atlas-urban.js').read_text(),'road-atlas-navigation.js':(ROOT/'road-atlas-navigation.js').read_text(),'road-atlas-streets.js':(ROOT/'road-atlas-streets.js').read_text(),'road-atlas-street-hooks.js':(ROOT/'road-atlas-street-hooks.js').read_text()}
