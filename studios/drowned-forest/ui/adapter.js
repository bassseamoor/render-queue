// Drowned Forest — SeedConsole adapter (from drowned-forest.html;
// modularized: studio state comes from window.__drownedHooks, exposed by ../app.js).

/* ============ Seed Console adapter: Drowned Forest ============ */
(function () {
  'use strict';
  var H = window.__drownedHooks; // exposed by ../app.js (modularized; was shared script scope)
  if (!H) { console.error('[drowned-forest] SeedConsole adapter: studio hooks missing'); return; }
  ...
  window.SeedConsoleAdapter = {
    studio: 'drowned-forest',
    title: 'Drowned Forest',
    ...
    randomSeed: function () { return H.codeOf(randomConfig()); },
    ...
    fileBase: function (seedStr) { return 'drowned-forest-' + String(seedStr).replace(/[^\w\-]+/g, '_'); }
  };
